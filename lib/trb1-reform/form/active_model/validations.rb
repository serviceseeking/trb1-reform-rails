...
module Trb1::Reform::Form::ActiveModel
  ...
  module Validations
    ...
    class Group
      def initialize
        @validations = Class.new(Trb1::Reform::Form::ActiveModel::Validations::Validator)
      end
    ...
    class Validator < SimpleDelegator
      ...
      class << self
        ...
        def validates(*args, &block)
          super(*Trb1::Declarative::DeepDup.(args), &block)
        end
  ...
  class Errors < ActiveModel::Errors
    include Trb1::Reform::Form::Errors::Merge
  end
end
