...
class Trb1::Reform::Form::UniqueValidator < ActiveModel::EachValidator
...
Trb1::Reform::Form::ActiveModel::Validations::Validator.class_eval do
  UniqueValidator = Trb1::Reform::Form::UniqueValidator
end
